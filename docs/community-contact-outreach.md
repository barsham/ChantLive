...
```text
I maintain ChantLive, a free/open-source real-time chant coordination tool for demonstrations and public events: https://chantlive.online/

Organizers control the current chant; participants join from a public link or QR code with no login. I am looking for a few organizers, accessibility reviewers, or civic-tech people willing to run a 10-minute test and tell me what would make it useful, unsafe, confusing, or not ready for real events.

Source: https://github.com/barsham/ChantLive

Would this be appropriate for someone in your team or network to review?
```

## First-Wave Targets

| Organization | Why it fits | Contact |
| --- | --- | --- |
| Sydney Alliance | Sydney community-organising network that brings together community organisations, unions, religious organisations, and schools. Good fit for workflow critique from real organizers. | https://www.sydneyalliance.org.au/contact-us / admin@sydneyalliance.org.au |
| Unions NSW | Campaign and event network for NSW unions; useful for rally and action logistics feedback. | https://unionsnsw.org.au/our-work/events/ / reception@unionsnsw.org.au |
| Refugee Action Coalition Sydney | Runs rallies, public forums, and information stalls; useful for real public-event testing. | https://refugeeaction.org.au/?page_id=1434 |
| Australian Conservation Foundation | National environmental advocacy group with community organizing and events. | https://www.acf.org.au/contact |
| Climate Action Network Australia | Network of climate campaigners and civil society groups; useful for campaign-tool feedback. | https://www.cana.net.au/contact / info@cana.net.au |
| People with Disability Australia | Accessibility and participant-experience review, especially for QR/public-link/live-update workflows. | https://pwd.org.au/contact-us/ / pwd@pwd.org.au |
| Sydney Web Accessibility & Inclusive Design | Local inclusive design/accessibility community; useful for expert accessibility testing. | https://www.meetup.com/sydney-web-accessibility-inclusive-design/ |
| Democracy Developers | Australian civic-tech charity; useful for public-interest tech, privacy, and deployment feedback. | https://www.democracydevelopers.org.au/about-us/ / info@democracydevelopers.org.au |
...
| Date | Organization | Email | Status |
| --- | --- | --- | --- |
| 2026-07-05 | Sydney Alliance | admin@sydneyalliance.org.au | Sent via Zoho SMTP |
| 2026-07-05 | Unions NSW | reception@unionsnsw.org.au | Sent via Zoho SMTP |
| 2026-07-05 | Climate Action Network Australia | info@cana.net.au | Sent via Zoho SMTP |
| 2026-07-05 | People with Disability Australia | pwd@pwd.org.au | Sent via Zoho SMTP |
| 2026-07-05 | Democracy Developers | info@democracydevelopers.org.au | Sent via Zoho SMTP |
| 2026-07-05 | Digital Rights Watch | info@digitalrightswatch.org.au | Sent via Zoho SMTP |
| 2026-07-05 | Electronic Frontiers Australia | info@efa.org.au | Sent via Zoho SMTP |
| 2026-07-05 | NSW Council for Civil Liberties | office@nswccl.org.au | Sent via Zoho SMTP |
